...
export const parseQuerySelector = (querySelector) => {
...
const parseArguments = (element, ...args) => {
  should(isNode(element),
 ...
 * @returns {NodeElement}
 */
export const createElement = (querySelector, ...args) => {
  const {
    tag,
    id,
    classList
  } = parseQuerySelector(querySelector)
